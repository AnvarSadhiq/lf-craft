<div class="d-flex align-items-stretch">
  ...
  <nav id="sidebar">
    ...
    <div class="sidebar-header d-flex align-items-center">
      <div class="avatar"><img src="{{asset('admincss/img/anvar.jpg')}}" alt="..." class="img-fluid rounded-circle"></div>
      <div class="title">
        <h1 class="h5">Anvar Sadiq</h1>
        <p>Web Developer</p>
      </div>
    </div>
    ...
    <ul class="list-unstyled">
      ...
      <li>
        <a href="{{url('view_orders')}}"> <i class="icon-grid">
          </i>Orders
        </a>
      </li>
    </ul>
